...
// এর ফলে কোড ছোট এবং পরিষ্কার হয়। সাধারণত আমরা আলাদাভাবে প্রোপার্টি ডিক্লেয়ার করে কনস্ট্রাক্টরে সেট করি, কিন্তু প্যারামিটার প্রোপার্টিজ দিয়ে এক ধাপে কাজটি করা যায়।
...
console.log(myCar.year); // Error: Property 'model' is private
